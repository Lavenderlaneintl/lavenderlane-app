...
import { chitchatOptions, intimacyOptions } from "@/utils/data";
import { useThemeColor } from "@/utils/hooks/useThemeColor";
import { IChitChatOptions } from "@/utils/interfaces/index.interfaces";

const IntimacyScreen = (): JSX.Element => {
        ...
        <View style={{ gap: Size.calcHeight(20) }}>
          <View style={styles.header}>
            ...
            <ThemedView style={styles.headerTitleContainer}>
              <ThemedText style={styles.headerTitle}>Intimacy</ThemedText>
            </ThemedView>
          </View>
          <FlatList
            data={intimacyOptions}
